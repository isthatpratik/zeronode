      ...
      <div className="grid-container">
        <FadeInSection className="col-span-4 md:col-span-8 lg:col-span-12">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            {/* 1. Offer at a Glance */}
            <section>
              <SectionHeader number="1" title="Offer at a Glance" />
              <StyledCard>
                <Table>
                  <TableBody>
                    <TableRow>
            ...
            {/* 2. Benchmarks */}
            <section>
              <SectionHeader number="2" title="How Does US $ 12 M Compare? — 2025 Benchmarks" />
              <StyledCard>
                <Table>
                  <TableHeader>
                    <TableRow>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  *Assumes standard 20-25% dilution when valuations weren&apos;t disclosed.
                </p>
                <p className="font-medium mt-4">
                  Take-away: our US $ 12 M cap sits right on today&apos;s AI-seed median.
                </p>
              </StyledCard>
            </section>
            ...
            <section>
              <SectionHeader number="3" title="Five-Year Conservative Forecast" />
              <StyledCard>
                <Table>
                  <TableHeader>
                    <TableRow>
            ...
            {/* 4. Valuation Math */}
            <section>
              <SectionHeader number="4" title="Valuation Math (Discounted)" />
              <StyledCard>
                <Table>
                  <TableHeader>
                    <TableRow>
                ...
                <p className="font-medium mt-4">
                  $16-19 M present value ⇒ ~30% upside to our $12 M cap.
                </p>
              </StyledCard>
            </section>
            ...
            {/* 6. Leadership Team */}
            <section>
              <SectionHeader number="6" title="Leadership Team" />
              <StyledCard>
            ...
            {/* 7. Why Invest Now */}
            <section>
              <SectionHeader number="7" title="Why Invest Now" />
              <StyledCard>
            ...
            <section>
              <SectionHeader number="8" title="Flexible Deal Structure" />
              <StyledCard>
                <ul className="list-disc list-inside space-y-2">
